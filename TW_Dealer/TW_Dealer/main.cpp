...
int start_service(){
	...
	{
		LOG4CPLUS_INFO(DealerLog::GetInstance()->m_Logger, "Bridge:GetInstance()->CreateBridgeLink success");
		OutputDebugString("ERR:Bridge:GetInstance()->CreateBridgeLink success");
	}
